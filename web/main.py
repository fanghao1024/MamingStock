...
import web.dataWeeklyLineHandler as dataWeeklyLineHandler
import web.dataPNFHandler as dataPNFHandler
import web.dataRenkoHandler as dataRenkoHandler
import web.dataRSHandler as dataRSHandler
...
class Application(tornado.web.Application):
    def __init__(self):
        handlers = [
            ...
            (r"/", HomeHandler),
            (r"/stock/", HomeHandler),
            (r"/test_akshare", TestHandler),# 测试页面，做写js测试。
            (r"/test2", Test2Handler),# 测试页面，做写js测试。
			...
			(r"/stock/data/weeklyLine", dataWeeklyLineHandler.GetDataWeeklyLineHandler),
            (r"/stock/data/pnf", dataPNFHandler.GetDataPNFHandler),
            (r"/stock/data/renko", dataRenkoHandler.GetDataRenkoHandler),
            (r"/stock/data/RS", dataRSHandler.GetDataRSHandler),
        ]
        settings = dict(  # 配置
