...
def FindCrossOver(Stockcode,startday,endday):
    ...
    if stock_daily_info['close'][-2] < stock_daily_info['open'][-2] and stock_daily_info['close'][-1] > stock_daily_info['open'][-1] \
            and stock_daily_info['open'][-1]<stock_daily_info['low'][-2] and stock_daily_info['close'][-1]>stock_daily_info['close'][-2]:
        if ((stock_daily_info['close'][-1]-stock_daily_info['close'][-2])/(stock_daily_info['open'][-2]-stock_daily_info['close'][-2]))>0.5:
            return 1
