...
def calculateMACD(closeArray, fastperiod=12, slowperiod=26, signalperiod=9):
    macd, diff, dea=ta.MACD(closeArray, fastperiod=8, slowperiod=17, signalperiod=9)
...
def CalcStockMACD(Stockcode,startday,endday):
    args = parse_args()
...
if __name__ == '__main__':
    ...
    for code, name in zip(stock_info_a_code_name_df['code'], stock_info_a_code_name_df['name']):
        ...
        if CalcStockMACD(code,startday,endday):
