...
def get_sh_daily_summary_information(startdate='19901217', enddate='21000101'):
    ...
    sql = 'select * from sh_summary_data where date >="{0}" and date<="{1}"'.format(startdate, enddate)
    df=pd.DataFrame()
    try:
...
# get_sh_daily_summary_information('000001','20200101','20211231')
#a = get_sh_daily_summary_information('20210317','20210317')
#print(a)
